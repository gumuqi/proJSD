...
var _banner = __webpack_require__(77);
...
var _news = __webpack_require__(82);

var _news2 = _interopRequireDefault(_news);

var _services = __webpack_require__(83);
...
_reactDom2.default.render(_react2.default.createElement(BasicExample, null), document.getElementById('content'));
...
var _bannerItem = __webpack_require__(78);

var _bannerItem2 = _interopRequireDefault(_bannerItem);

var _bannerDots = __webpack_require__(79);

var _bannerDots2 = _interopRequireDefault(_bannerDots);
...
var Banner = function (_React$Component) {
    ...
    function Banner(props) {
        ...
        _this.count = 6;
        _this.transition = "all 0.8s linear";
        _this.time = null;
        return _this;
    }
    ...
    _createClass(Banner, [{
        ...
        value: function render() {
            ...
            Images.forEach(function (item, i) {
                ImageLi.push(_react2.default.createElement(_bannerItem2.default, { key: i, item: item, count: _this3.count }));
            });
            ImageLi.push(_react2.default.createElement(_bannerItem2.default, { key: this.count - 1, item: Images[0], count: this.count }));

            var width = this.props.width * this.count;
            return _react2.default.createElement(
                'section',
                { className: 'container', onMouseOver: this.pause.bind(this), onMouseOut: this.goplay.bind(this) },
                _react2.default.createElement(
                    'ul',
                    { id: 'banner', style: { width: width, position: 'relative', top: 0, left: '-800' * this.state.curIndex + 'px', transition: this.transition } },
                    ImageLi
                ),
                _react2.default.createElement(_bannerDots2.default, { count: this.count - 1, turn: this.turn.bind(this), nowLocal: this.state.curIndex === this.count - 1 ? 0 : this.state.curIndex })
            );
        }
    }]);
...
var BannerDots = function (_React$Component) {
    _inherits(BannerDots, _React$Component);

    function BannerDots(props) {
        _classCallCheck(this, BannerDots);

        return _possibleConstructorReturn(this, (BannerDots.__proto__ || Object.getPrototypeOf(BannerDots)).call(this, props));
    }

    _createClass(BannerDots, [{
        key: 'handleDotClick',
...
var News = function (_React$Component) {
	...
	function News() {
		...
		return _possibleConstructorReturn(this, (News.__proto__ || Object.getPrototypeOf(News)).call(this));
	}
